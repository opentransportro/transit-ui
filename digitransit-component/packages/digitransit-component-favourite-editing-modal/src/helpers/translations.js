const translations = {
  ...
  ro: {
    cancel: 'Anulează',
    delete: 'Șterge',
    'delete-place-header': 'Vrei să ștergi această locatie?',
    'delete-place-name': 'Șterge locatie: {{favourite.name}}',
    'edit-places': 'Modifică locații',
    'edit-place-name': 'Modifica locație: {{favourite.name}}',
    'edit-modal-on-open': 'Modal editare favorite.',
    'choose-icon': 'Selectează locația favoritei.',
    'close-modal': 'Inchide modalul',
    'input-placeholder': 'Adaugă un nume pentru locație (optional)',
    save: 'Salveză',
    'save-place': 'Salvează locatie',
  },
  fi: {
    cancel: 'Peruuta',
    delete: 'Poista',
