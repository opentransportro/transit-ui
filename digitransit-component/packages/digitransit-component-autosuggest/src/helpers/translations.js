const translations = {
  ...
  ro: {
    ...
    'add-via-duration-button-label-open':
      'Deschide selectorul duratei opririi la punctul intermediar {{index}}',
    airplane: 'Zbor',
    arrival: 'Sosire',
    back: 'Înapoi',
    bikerentalstation: 'Stație de biciclete',
    bus: 'Autobuz',
    cancel: 'Anulare',
    ...
    delete: 'Șterge',
    'delete-old-searches-header': 'Vrei să ștergi istoricul căutărilor?',
    departure: 'Plecare',
    destination: 'Destinație',
    'give-origin': 'Introdu punctul de plecare.',
    'give-destination': 'Introdu destinația',
    favourite: 'Favorite',
    ferry: 'Feribot',
    'future-route': 'Ruta viitoare',
    origin: 'Punct de plecare',
    'origin-stop-near-you': 'Punct de plecare ',
    ownlocations: 'Locații proprii',
    loading: 'Se încarcă...',
    'minute-short': 'm',
    rail: 'Tren',
    search: 'Căutare',
    'search-address-or-place': 'Caută după adresă sau după numele locului',
    'search-button-label': 'Caută',
    'search-destination': 'Caută destinația ruta sau stația',
    'search-destination-index': 'Introdu destinația',
    'search-destination-results-but-no-search':
      'Vezi rezultatele în secțiunea adiacentă "Destinații"',
    'search-no-results': 'Nici o locație',
    'search-origin': 'Caută punctul de plecare, ruta sau stația',
    'search-origin-index': 'Introdu punctul de plecare',
    'search-position': 'Detectează locația',
    'search-autosuggest-label':
    ...
    station: 'Gară',
    stop: 'Stație',
    'stop-near-you': 'Caută stații și rute',
    'stop-near-you-bus': 'Caută rute de autobuz sau stații',
    'stop-near-you-citybike': 'Caută stații de biciclete publice',
    'stop-near-you-rail': 'Caută rute de tren sau stații',
    'stop-near-you-subway': 'Caută rute de metrou sau stații',
    'stop-near-you-tram': 'Caută rute de tramvai sau stații',
    'stop-route-station': 'Caută autobuze și opriri',
    today: 'azi la',
    tomorrow: 'mâine la',
    tram: 'Tramvai',
    'use-own-position': 'Folosește locația curentă',
    'select-from-map': 'Selectează locația pe hartă',
    'select-from-own-locations': 'Selectează din locațiile proprii',
    venue: 'Locație',
