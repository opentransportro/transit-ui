const translations = {
  ...
  ro: {
    'pick-mode': 'Selectează mod transport',
    'pick-mode-airplane': 'Avion',
    'pick-mode-bus': 'Autobuz',
    'pick-mode-citybike': 'Bicicletă',
    'pick-mode-ferry': 'Feribot',
    'pick-mode-rail': 'Tren',
    'pick-mode-subway': 'Metrou',
    'pick-mode-tram': 'Tramvai',
    'placeholder-destination': 'Adaugă destinație',
    'placeholder-origin': 'Adaugă origine',
    'placeholder-route-stop-station': 'Introdu o rută sau o stație / oprire',
    'title-route-stop-station': 'Stații si rute in apropiere',
    'title-origin-to-destination': 'Incotro?',
