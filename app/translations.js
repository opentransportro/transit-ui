...
const translations = {
  ...
  ro: {
    ...
    'choose-stop-or-vehicle': 'Select vehicul sau stație',
    'choose-vehicle': 'Select vehicul',
    ...
    'itinerary-details.walk-leg':
      'La {time} mergeți pe jos {distance} de la {origin} la {destination}. Va dura aproximativ {duration}',
    ...
    'itinerary-summary-page-street-mode.update-alert':
      'Rezultatele mersului pe jos și a mersului cu bicicleta au fost actualizate',
    ...
    origin: 'Plecare',
    'origin-outside-service':
      'Din păcate nu a fost găsită nicio rută pentru călătoria dumneavoastră. Punctul de plecare este localizat în afara ariei serviciilor, vă rugăm modificați. ',
    ...
    'required-ticket': 'Bilet necesar pentru călătorie',
    ...
    'search-destination-index': 'Introdu destinația',
    'search-destination-results-but-no-search':
    ...
    'search-origin-index': 'Introdu punctul de plecare',
    ...
    'aria-itinerary-summary': 'Timp pentru itinerar: {duration} ',
    'aria-itinerary-summary-bike-distance': 'Distanță de pedalat {distance} ',
    'aria-itinerary-summary-walk-distance': 'Distanță mers pe jos: {distance} ',
    bicycle_walk: 'Împingeți bicicleta',
    'bikes-available': '{amount} biciclete in stație ',
    'citybike-buy-season': 'Cumpără un abonament zilnic, saptămânal sau lunar',
    'citybike-purchase-link': 'Cumpără',
    'citybike-start-using': 'Începe să utilizezi biciletele',
    'citybike-station': 'Stație de biciclete {stationId}',
    'citybike-station-no-id': 'Stație biciclete',
    'close-favourite-module': 'Închide modulul favorite',
    'close-settings': 'Închide fereastra și salvează modificări',
    'departures-by-hour': 'Plecări ordonate după ora (minute/linie)',
    'from-station': 'de la stația',
    'from-stop': 'de la punctul',
    'itinerary-page.itineraries-loaded': 'Încarcă mai multe variante',
    'itinerary-page.loading-itineraries': 'Se încarcă mai multe variante',
    'itinerary-page.show-details-label':
      'Arată detalii pentru itinerarul {number}',
    'itinerary-summary-row.first-leg-start-time':
      'Pleacă la {firstDepartureTime} {firstDepartureStopType} {firstDepartureStop}{firstDeparturePlatform}',
    'itinerary-summary-row.first-leg-start-time-citybike':
      'Plecare la {firstDepartureTime} de la stația de biciclete {firstDepartureStop}',
    'itinerary-summary-row.no-transit-legs': 'Pleacă când crezi tu de cuviință',
    'itinerary-summary.bikeAndPublic-fallback-title':
      'Ia bicicleta cu tine la bord',
    'itinerary-summary.bikeAndPublic-rail-subway-title':
      'Ia bicicleta cu tine in tren sau metrou',
    'itinerary-summary.bikeAndPublic-rail-title':
      'Ia bicicleta cu tine in tren',
    'itinerary-summary.bikeAndPublic-subway-title': 'Ia bicicleta către metrou',
    'itinerary-summary.bikePark-title': 'Lasă bicicleta la un Park & Ride',
    'itinerary-summary.interline-wait':
      'Așteaptă transferul ({time})',
    'location-from-map-confirm': 'Confirmă selecția',
    'login-content':
      'Pentru a salva și folosi puncte de interes, rute și stații, trebuie să te loghezi folosind contul tău HSL.',
    'login-header': 'Autentifică-te întâi',
    'more-departures': 'Mai multe plecări',
    'nearest-stops': 'Stațiile apropiate',
    'nearest-stops-bus': 'Stațiile de autobuz apropiate',
    'nearest-stops-citybike': 'Stațiile de biciclete apropiate',
    'nearest-stops-ferry': 'Stațiile de feribot apropiate',
    'nearest-stops-rail': 'Stațiile de tren apropiate',
    'nearest-stops-subway': 'Stațiile de metrou apropiate',
    'nearest-stops-tram': 'Stațiile de tramvaiapropiate',
    'nearest-stops-update-location': 'Actualizare {mode}',
    'nearest-stops-updated-location': 'Locația de pe hartă s-a schimbat',
    'no-route-origin-same-as-destination':
      'Nu s-au găsit sugestii de rute, deoarece originea și destinația sunt aceleași.',
    'no-route-showing-alternative-options':
      'Nu au fost găsite sugestii de rute cu setările dvs.Cu toate acestea, am găsit următoarele opțiuni de traseu:',
    'pick-street-mode': 'Modurile mele de transport',
    platform: 'Platformă',
    'remove-favourite': 'Elimină selecția favorită',
    'select-all-routes': 'Selectează toate rutele',
    'select-from-map-destination': 'Selectează destinația',
    'select-from-map-no-title': 'Niciun titlu',
    'select-from-map-origin': 'Selectează punctul de plecare',
    'select-from-map-viaPoint': 'Selectează punctul de referință',
    'select-route': 'Select {mode} route {shortName} to {headsign}',
    'set-specific-settings': 'Setează setări mai specifice',
    'settings-dropdown-close-label': 'Opțiuni de închidere',
    'settings-dropdown-open-label': 'Opțiuni de deschidere',
    'show-more-stops-near-you': 'Arată mai multe stații în preajmă',
    'stop-near-you': 'Caută stații și rute în apropiere',
    'stop-near-you-modal-grant-permission': 'sau permite accesul la locație',
    'stop-near-you-modal-grant-permission-info':
      'Poți permite accesul la locația ta în setările telefonului sau în setările motorului de căutare.',
    'stop-near-you-modal-header': 'Nu ai permis accesul la locația ta',
    'stop-near-you-modal-info':
      'Pentru a vedea stațiile din apropiere, e nevoie accesarea locației curente.',
    'stop-near-you-title': 'Caută stații și rute',
    'stop-near-you-update-alert': 'Stațiile din apropiere au fost actualizate',
    'stop-page.right-now.loaded': 'Pagina stațiilor a fost încărcată',
    'street-mode-bike-aria':
      'Arată ruta pistei de biciclete. Durata {duration}, distanța {length}',
    'street-mode-bikeandvehicle-aria':
      'Arată o combinație de mers cu bicicleta și transport public. Durata {duration}, distanța {length}      ',
    'street-mode-walk-aria':
      'Arată traseul de mers pe jos. Durata {duration}, distanța {length}',
    track: 'Track',
    'use-national-service-postfix': '.',
    'use-national-service-prefix':
      'Vă recomandăm să încercați planificatorul național de călătorit, ',
    userinfo: 'My information',
    'walk-bike-itinerary-1': 'Rezultatele căutării tale sunt doar rute de mers pe jos.',
    'walk-bike-itinerary-2': 'Rezultatele căutării tale sunt doar rute de mers cu bicicleta.',
    'walk-bike-itinerary-3':
      'Rezultatele căutării tale sunt doar rute de mers pe jos și cu bicicleta.',
    weather: 'Weather',
    'weather-data-source': 'Sursa: Institutul Național de Meteorologie',
    'weather-detail-title': 'Prognoza meteo pentru locația curentă',
    'weather-icon-1': 'Senin',
    'weather-icon-2': 'Parțial noros',
    'weather-icon-21': 'Averse ușoare',
    'weather-icon-22': 'Averse de ploaie',
    'weather-icon-23': 'Averse puternice',
    'weather-icon-3': 'Acoperit de nori',
    'weather-icon-31': 'Averse ușoare',
    'weather-icon-32': 'Averse de ploaie',
    'weather-icon-33': 'Averse puternice',
    'weather-icon-41': 'Averse ușoare de zăpadă',
    'weather-icon-42': 'Averse de zăpadă',
    'weather-icon-43': 'Averse puternice de zăpadă',
    'weather-icon-51': 'Ninsori slabe',
    'weather-icon-52': 'Ninsori',
    'weather-icon-53': 'Ninsori puternice',
    'weather-icon-61': 'Descărcări electrice',
    'weather-icon-62': 'Descărcări electrice puternice',
    'weather-icon-63': 'Tunete',
    'weather-icon-64': 'Tunete puternice',
    'weather-icon-71': 'Lapoviță',
    'accessibility-statement': 'Declarație de accesibilitate',
    'add-home': 'Adaugă acasă',
    'weather-icon-72': 'Lapoviță',
    'weather-icon-73': 'Averse cu lapoviță',
    'weather-icon-81': 'Lapoviță ușoară',
    'weather-icon-82': 'Lapoviță',
    'weather-icon-83': 'Averse cu lapoviță',
    'weather-icon-91': 'Ceață',
    'weather-icon-92': 'Ceață',
  },
